...
export default function MarqueeList() {
  return (
    <div className='relative z-20 flex w-full flex-col items-center justify-center overflow-hidden lg:shadow-xl'>
      ...
      <div className='pointer-events-none absolute inset-y-0 left-0 w-1/3 bg-linear-to-r from-white dark:from-black' />
      <div className='pointer-events-none absolute inset-y-0 right-0 w-1/3 bg-linear-to-l from-white dark:from-black' />
    </div>
  );
}
